...
if(isset($_GET['id'])){
	...
	$category_product=mysqli_query($conn,"SELECT * FROM products WHERE products.category_id='$id' ORDER BY id DESC");
	$category_name=mysqli_query($conn,"SELECT * FROM categories WHERE id='$id'" );
...
<div class="ads-grid py-sm-5 py-4">
		<div class="container py-xl-4 py-lg-2">
			...
			<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3">
				<?php  
					while($row_category_name=mysqli_fetch_array($category_name)){
				...
				<div class="agileinfo-ads-display col-lg-9">
					<div class="wrapper">
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							<div class="row">
							<?php 
								while($row_category_product=mysqli_fetch_array($category_product)){
							?>
								<div class="col-md-4 product-men">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="images/<?php  echo $row_category_product['product_image']?>" alt="">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="?quanly=chitietsp&id=<?php  echo $row_category_product['id']?>" class="link-product-add-cart">Quick View</a>
												</div>
											</div>
										</div>
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="?quanly=chitietsp&id=<?php  echo $row_category_product['id']?>"><?php echo $row_category_product['product_name'] ?></a>
											</h4>
											<div class="info-product-price my-2">
												<span class="item_price"><?php  echo  number_format($row_category_product['product_discount']).'đ'?></span>
												<del><?php  echo  number_format($row_category_product['product_price']).'đ'?></del>
											</div>
